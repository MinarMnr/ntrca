...
const ExperienceSubjectWisePostList = () => {
    ...
    const cardProps = {
        title: "স্তর ও বিষয় ভিত্তিক পদবির তালিকা",
        headerSlot: () => (
            <Link to="/portal/settings/experience-subject-wise-post-add">
                <Button variant="link" className="f-right btn-sm btn-color">
                    <FontAwesomeIcon icon={faPlus} className="me-2" />
                    নতুন স্তর ও বিষয় ভিত্তিক পদবি যোগ করুন
                </Button>
            </Link>
        ),
    };
    ...
    const tableProps = {
        headers: [
            { id: "id", label: "ক্রঃ নঃ" },
            { id: "Post", label: "নতুন স্তর ও বিষয় ভিত্তিক পদবির কোড " },
            {
                id: "SubjectWisePostName",
                label: "নতুন স্তর ও বিষয় ভিত্তিক পদবির নাম",
            },
        ...
        config: {
            operationId: UrlBuilder.ntrcaApi(
                `post-subject-education-level-mapping/list?${new URLSearchParams(
                            ...
                            <tr key={index}>
                                ...
                                <td>
                                    <span className="text-center">
                                        {row.postSubjectEducationLevelMappingId}
                                    </span>
                                </td>
                                <td>
                                    <span className="text-center">
                                        {
                                            row.postSubjectEducationLevelMappingNameBn
                                        }
                                    </span>
                                </td>
...
export default ExperienceSubjectWisePostList;
