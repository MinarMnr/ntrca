...
class TeacherJoiningModel {
     ...
     */
    fromJson(data = {}) {
        let obj = new TeacherJoiningModel();
        ...
        obj.joiningType = data.joiningType ?? "NEW_JOINING";
     ...
     */
    toString(data = {}) {
        let obj = new TeacherJoiningModel().fromJson(data);
...
export const TeacherJoining = new TeacherJoiningModel();
